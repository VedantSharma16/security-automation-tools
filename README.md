...
| Project | Description |
|---|---|
| [`phishing-triage/`](phishing-triage/) | Parses raw `.eml` emails and triages them for phishing indicators: SPF/DKIM/DMARC verdicts, suspicious-link heuristics (userinfo spoofing, punycode, brand impersonation, display/href mismatches), social-engineering language, sender impersonation, and disguised attachments — combined into a 0-100 score with an optional LLM-generated analyst narrative. Fully tested with pytest; works offline by default. |
