...
| [`secret-scanner/`](secret-scanner/) | Git-friendly static-analysis tool for hardcoded credentials: 16 vendor signature rules (AWS, GitHub, Slack, Stripe, private keys, ...) plus Shannon-entropy detection for generic secrets, with baseline suppression, JSON/SARIF output, and CI-friendly exit codes. Fully tested with pytest; works offline. |
