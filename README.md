...
| [`web-recon-toolkit/`](web-recon-toolkit/) | Authorized-use web app recon: OWASP-mapped security-header/cookie audit, sensitive-file exposure discovery (with soft-404 baselining), and tech fingerprinting, with a risk score and a hard authorization gate. Pentest/red-team-facing counterpart to the blue-team tools above; fully tested against a local HTTP fixture. |
