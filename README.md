...
| [`vuln-prioritizer/`](vuln-prioritizer/) | Scores vulnerability scan findings against EPSS (exploit prediction), CISA's Known Exploited Vulnerabilities catalog, and asset business-criticality/exposure to produce a ranked, auditable patch-priority report — correcting the common "sort by CVSS" anti-pattern. Optional LLM-generated executive narrative, 55 tests, fully offline. |
