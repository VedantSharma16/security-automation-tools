...
| Project | Description |
|---|---|
| [`secrets-scanner/`](secrets-scanner/) | DevSecOps secret scanner: checks both the working tree and full git commit history (catching credentials committed and later "removed") for AWS/GitHub/Stripe/Slack/Google/Twilio/NPM tokens, private keys, JWTs, and generic high-entropy strings. Rule-based false-positive triage runs before an optional LLM-written analyst narrative. Fully tested with pytest; works offline by default. |
