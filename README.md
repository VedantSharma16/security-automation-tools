...
| [`web-security-auditor/`](web-security-auditor/) | Read-only, Observatory-style HTTP security audit: grades security headers, cookie flags, CORS misconfiguration, TLS/certificate health, and information disclosure, with a 0-100 score, letter grade, and remediation per finding. Stdlib-only, fully unit-tested against mocked HTTP responses. |
